...
function playerCollision(){
	...
	//Horizontal Entities
	var _entityCount = instance_position_list(x+hSpeed, y, par_entity,_entityList, false);
	var _snapX;
	...
	//Vertical Entities
	var _entityCount = instance_position_list(x, y + vSpeed, par_entity,_entityList, false);
	var _snapY;
